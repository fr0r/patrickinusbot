...
bot.on("ready",function(){   
   ...
   bot.user.setPresence({ game: { name: "e dando a as" , type: 0 } });
...
if (server.dispatcher) server.dispatcher.end();
    ...
    message.channel.send ( {files: ["./legal/" + videoNumber + ".mp4"]} )
    break;
    case "novidades":
    ...
    break;
    case "say":
    if (!message.member.hasPermission("MANAGE_MESSAGES")) return message.reply("Meu cornometro mostrou que você não tem permissão");
